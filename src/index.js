...
const images = {
  eightyDegreesK: require('../assets/courtney-cook-HClKQKUodF4-unsplash.jpg'),
  seventyDegreesK: require('../assets/clement-fusil-Fpqx6GGXfXs-unsplash.jpg'),
  sixtyDegreesK: require('../assets/dedu-adrian-BxT5oqgztNc-unsplash.jpg'),
  fiftyDegreesK: require('../assets/nick-scheerbart-soGoAfesWO8-unsplash.jpg'),
  fortyDegreesK: require('../assets/james-donovan-kFHz9Xh3PPU-unsplash.jpg'),
  elseImgK: require('../assets/fabien-twb-6K_WE8FB3bE-unsplash.jpg'),
};
...
const changeBgImg = () => {
  ...
  if (state.temp >= 80) {
    bodyElement.className = 'eightyDegrees';
  } else if (state.temp >= 70) {
    bodyElement.className = 'seventyDegrees';
  } else if (state.temp >= 60) {
    bodyElement.className = 'sixtyDegrees';
  } else if (state.temp >= 50) {
    bodyElement.className = 'fiftyDegrees';
  } else if (state.temp >= 40) {
    bodyElement.className = 'fortyDegrees';
  } else {
    bodyElement.className = 'elseImg';
  }
};
